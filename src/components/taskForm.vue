...
<template>
  <div
    class="fixed bottom-0 left-0 right-0 p-6 bg-linear-to-t from-slate-900 via-[#0f172a] to-transparent"
  >
    <div class="max-w-3xl mx-auto">
      <div
        class="focus-within:border-cyan-500/50 px-6 py-7 mb-2 border bg-slate-900 border-slate-800 rounded-2xl duration-300 transition-all"
      >
        <input
        ...
        />
        <div class="flex max-[400px]:gap-y-2 max-[400px]:flex-col justify-between pt-3">
          <div
            class="flex items-center max-[400px]:justify-center bg-slate-800/50 p-1 rounded-lg border border-slate-700/50"
          >
            <button
